...
# print(....)
print ("Numeros enteros solicitados", numero_1, "y", numero_2)
...
print ("El reultado de sumar es", numero_1 + numero_2)
# Resta
print ("El resultado de restar es", numero_1 - numero_2)
# División
print ("El resultado de dividir es", numero_1 / numero_2)
# Multiplicación
print ("El resultado de multiplicar es", numero_1 * numero_2)